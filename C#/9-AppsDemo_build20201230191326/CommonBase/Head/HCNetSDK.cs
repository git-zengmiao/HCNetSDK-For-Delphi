...
namespace Common
{
    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public const int WARNONMONITOR = 1;/*显示器上警告*/
        ...
        public const int MINOR_LOCAL_ALLOWLIST_SET = 0x35A; /*本地配置准入名单*/
        public const int MINOR_REMOTE_ALLOWLIST_SET = 0x35B; /*远程配置准入名单*/
        ...
        public const int MINOR_LOCAL_ADD_MONITOR_INFO = 0x2005; // 本地添加布防信息 
        public const int MINOR_LOCAL_MOD_MONITOR_INFO = 0x2006; // 本地修改布防信息 
        public const int MINOR_LOCAL_DEL_MONITOR_INFO = 0x2007; // 本地删除布防信息 
        public const int MINOR_LOCAL_FIND_MONITOR_INFO = 0x2008; // 本地查询布防信息 
        ...
        public const int NET_VCA_GET_RULECFG_V41 = 5011;//获取异常行为检测参数(扩展)
        public const int NET_VCA_SET_RULECFG_V41 = 5012;//设置异常行为检测参数(扩展)
        ...
        public const int NET_DVR_GET_RULECFG_V42 = 5049;//获取异常行为检测参数(支持16条规则扩展)
        public const int NET_DVR_SET_RULECFG_V42 = 5050;//设置异常行为检测参数(支持16条规则扩展)
        ...
        public struct NET_DVR_DEVICEINFO_V30
        {
            ...
            */
            ...
            // bySupport7 & 0x40  表示设备是否支持 主从_（从摄像机）
        ...
        public struct NET_VCA_FACESNAP_ADDINFO
        {
            ...
            public byte[] szCustomChanID;// 自定义_点通道号  string  max.len = 64
...
*/
        ...
        **********************************************************/
        ...
        public struct tagNET_VCA_ONE_RULE
        {
            ...
            public tagNET_VCA_EVENT_UNION uEventParam;//异常行为检测事件参数
        ...
        public struct tagNET_DVR_LF_TRACK_MODE
        {
            ...
            public struct uModeParam
            {
                ...
                public uint[] dwULen;
                [FieldOffsetAttribute(0)]
                public tagNET_DVR_LF_MANUAL_CTRL_INFO struManualCtrl;//手动_结构
                [FieldOffsetAttribute(0)]
                public tagNET_DVR_LF_TRACK_TARGET_INFO struTargetTrack;//目标_结构
            }
        }
        ...
        **********************************************************/
        ...
        public const int NET_DVR_CONTROL_PTZ_MANUALTRACE = 3316; //手动_定位
        public const int NET_DVR_GET_SMARTTRACKCFG = 3293; //获取智能运动_配置信息    
        public const int NET_DVR_SET_SMARTTRACKCFG = 3294; //设置智能运动_配置信息
        ...
        public struct NET_DVR_PTZ_MANUALTRACE
        {
            ...
            public byte byTrackType;    //_类型（手动_默认是0） 0、非自动取证(普通取证) 1、高速道路_ 2、城市道路_（手动_取证）3、静态取证
            public byte byLinkageType;//联动动作: 0-手动_ 1-联动不_
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes; //保留
            public NET_VCA_POINT struPointEnd;  //定位坐标(启示坐标)
            public NET_DVR_TIME_V30 struTime;   //手动_定位，当前时间
        ...
        public struct NET_DVR_FACE_DETECTION
        {
            ...
            public uint dwBackgroundPicLen; //背景图的长度，为0表示没有图片，大于0表示有图片
            public NET_VCA_DEV_INFO struDevInfo;   //前端设备信息
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK.MAX_FACE_PIC_NUM, ArraySubType = UnmanagedType.Struct)]
        ...
        public static void AddLog(int iDeviceIndex, int iLogType, string strFormat)
        {
            ...
            IDeviceTree g_deviceTree = PluginsFactory.GetDeviceTreeInstance();
            ...
            {
                if (null == g_deviceTree || null == g_deviceTree.GetSelectedDeviceInfo().sDeviceIP)
                {
                    strDevInfo = null;
                }
                else
                {
                    strDevInfo = string.Format("{0}-{1}", g_deviceTree.GetSelectedDeviceInfo().sDeviceIP, g_deviceTree.GetSelectedDeviceInfo().sDeviceName);
                }
            }

            switch (iLogType)
            {
                case CHCNetSDK.OPERATION_SUCC_T:
                    strErrInfo = "";
                    strlogType = "SUCC";
                    break;
                case CHCNetSDK.PLAY_SUCC_T:
                    strErrInfo = "";
                    strlogType = "SUCC";
                    break;
                case CHCNetSDK.PLAY_FAIL_T:
                    strErrInfo = "PLAY_M4 Eorror!!!";
                    break;
                case CHCNetSDK.OPERATION_FAIL_T:
