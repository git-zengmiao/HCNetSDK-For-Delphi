...
namespace PlanTemplate
{
    public partial class WeekPlan : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (m_struPlanCfg.struPlanCfg[iDate].struTimeSegment.struEndTime.byHour == 23
                && m_struPlanCfg.struPlanCfg[iDate].struTimeSegment.struEndTime.byMinute == 59
                && m_struPlanCfg.struPlanCfg[iDate].struTimeSegment.struEndTime.bySecond == 59)
            {
