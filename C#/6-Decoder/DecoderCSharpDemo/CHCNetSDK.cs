...
namespace DecoderCSharpDemo
{
    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public const int COMM_ITS_BLOCKLIST_ALARM = 0x3057;  //非准入名单报警上传
        ...
        **************************************************/
        ...
        public struct NET_DVR_DEV_CHAN_INFO_EX
        {
            ...
            public string sUserName;  	        //_主机登陆帐号
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = PASSWD_LEN)]
            public string sPassword;  	        //_主机密码
        }
        ...
        public struct NET_DVR_TRACK_MODE
        {
            ...
            public struct uModeParam
            {
                ...
                public uint[] dwULen;
                [FieldOffsetAttribute(0)]
                public NET_DVR_MANUAL_CTRL_INFO struManualCtrl;//手动_结构
            }
        }
