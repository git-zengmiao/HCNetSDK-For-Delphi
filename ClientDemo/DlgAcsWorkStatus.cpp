...
void CDlgAcsWorkStatus::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_EDIT_WFACE_NUM, m_dwAllowFaceNum);
    DDX_Text(pDX, IDC_EDIT_BFACE_NUM, m_dwBlockFaceNum);
}
...
void CDlgAcsWorkStatus::UpdateControlData()
{
    ...
    m_dwBlockFaceNum = m_struAcsWorkStatus.dwBlockFaceNum;
    m_dwAllowFaceNum = m_struAcsWorkStatus.dwAllowFaceNum;
    UpdateData(FALSE);
}
