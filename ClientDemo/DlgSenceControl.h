...
#define SCENE_NUM 8
#define TIMER_UPDOWNLOAD_SCENE_FILE_PROGRESS 1 //上传下载进度定时器
...
public:
    ...
    CString m_csSceneFileSavePath;
    CString m_csSceneFileSeletePath;
    int m_iUpdownloadHandle;
    int m_iDownloadHandle;
    DWORD m_dwSceneFileLen;
    BOOL m_bUploading;        //正在上传
    BOOL m_bDownloading;      //正在下载
	void DrawList();
    afx_msg void OnBnClickedBtnImportSceneFile();
