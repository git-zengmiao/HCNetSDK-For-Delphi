...
BEGIN_MESSAGE_MAP(CDlgVideoIntercomCfg, CDialog)
    ...
    ON_BN_CLICKED(IDC_BTN_DOOR_CONTENT, &CDlgVideoIntercomCfg::OnBnClickedBtnDoorContent)
END_MESSAGE_MAP()
...
void CDlgVideoIntercomCfg::OnBnClickedBtnDoorContent()
{
    // TODO:  在此添加控件通知处理程序代码
    CDialogDoorContent dlg;
    dlg.DoModal();
}
