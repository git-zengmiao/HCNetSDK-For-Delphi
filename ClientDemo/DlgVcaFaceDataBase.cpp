...
//	char szLan[128] = {0};
	...
	csTmp.Format("%d", g_pVcaFaceDataBase->m_lBlockListNum+1);
	g_pVcaFaceDataBase->m_listDataBase.InsertItem(g_pVcaFaceDataBase->m_lBlockListNum, csTmp,0);
	...
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 1, csTmp);
	
	csTmp.Format("%s", struBlockListData.struAttribute.byName);
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 2, csTmp);
	...
	csTmp.Format("%s", szLan);
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 3, csTmp);
	
	csTmp.Format("%d", 20);
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 4, csTmp);
	
	csTmp.Format("%d", struBlockListData.struAttribute.dwNativePlace);
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 5, csTmp);
	
	csTmp.Format("%d", 50);
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 6, csTmp);
	
	csTmp.Format("%d", 20);
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 7, csTmp);
	...
	csTmp.Format("%s", szLan);
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 8, csTmp);
	
	csTmp.Format("%s", "33012001");
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 9, csTmp);
	
	csTmp.Format("%s", "");
	g_pVcaFaceDataBase->m_listDataBase.SetItemText(g_pVcaFaceDataBase->m_lBlockListNum, 10, csTmp);		
*/	
    UpdateData(FALSE);
...
void CDlgVcaFaceDataBase::OnBtnRegister() 
{
    ...
    {
		g_pMainDlg->AddLog(m_iDevIndex, OPERATION_SUCC_T, "NET_DVR_AddBlockList m_iDataBaseID[%d] ",m_iDataBaseID);
