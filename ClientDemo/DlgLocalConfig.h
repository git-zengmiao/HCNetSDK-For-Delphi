...
public:
    ...
    afx_msg void OnBnClickedBtnSelectCertificationPath();
    CString m_csCertificationPath;
    BOOL m_bFastUpgrade;
    afx_msg void OnBnClickedBtnP2pCfg();

    CString m_csLibcryptoPath;
    CString m_csLibsslPath;
    afx_msg void OnBnClickedBtnSelectLogLibcrypto();
    afx_msg void OnBnClickedBtnSelectLogLibssl();
};
