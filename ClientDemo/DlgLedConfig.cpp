...
//	ON_BN_CLICKED(IDC_BUT_OUTPUT_PORTCFG_ADD, OnButPortcfgAdd)
    ...
    ON_BN_CLICKED(IDC_BTN_OPEN_AUDIO_CONTROL_FILE_UI, &CDlgLedConfig::OnBnClickedBtnOpenAudioControlFileUi)
END_MESSAGE_MAP()
...
void CDlgLedConfig::OnBnClickedBtnOpenAudioControlFileUi()
{
    // TODO:  在此添加控件通知处理程序代码
    CDlgAudioControlFile dlg;
    dlg.m_iUserID = m_lUserID;
    dlg.m_iDeviceIndex = m_lDeviceID;
    dlg.DoModal();
}
