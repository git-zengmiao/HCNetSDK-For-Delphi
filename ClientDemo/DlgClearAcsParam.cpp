...
void CDlgClearAcsParam::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_CHECK_BLOCKLIST_PIC, m_bBlockListPic);
    DDX_Check(pDX, IDC_CHECK_BLOCKLIST, m_bBlockList);
    DDX_Check(pDX, IDC_CHECK_BLOCK_FAILED_FACE, m_bFailedFace);
}
...
void CDlgClearAcsParam::OnBtnClearAcsParam() 
{
    ...
    struAcsParam.dwParamType |= (m_bBlockListPic << 18);
    struAcsParam.dwParamType |= (m_bBlockList << 19);
