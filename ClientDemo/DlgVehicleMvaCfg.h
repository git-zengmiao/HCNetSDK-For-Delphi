...
// Dialog Data
	...
	BOOL	m_bRadarUpload;
	BOOL	m_bBlockListAlarm;
	BOOL	m_bBlockListCheck;
	BOOL	m_bBlockListHint;
	BOOL	m_bBlockListUpload;
...
protected:
	...
	afx_msg void OnBtnSetBlockListCfg();
	afx_msg void OnBtnGetBlockListCfg();
...
public:
	...
	NET_DVR_MOBILE_LOCALPLATECHK_CFG m_struBlockListCfg;
