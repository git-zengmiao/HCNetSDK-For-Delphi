...
CDlgAlarmOnekey::CDlgAlarmOnekey(CWnd* pParent /*=NULL*/)
    ...
    , m_iCalledWaitedTime(0)
    , m_csWelcomeFile(_T(""))
    , m_csFarewellFile(_T(""))
    , m_csCalledVoicePromptName(_T(""))
{
...
void CDlgAlarmOnekey::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_EDIT_CALLED_WAITED_TIME, m_iCalledWaitedTime);
    DDX_Text(pDX, IDC_EDIT_WELCOME_FILE, m_csWelcomeFile);
    DDX_Text(pDX, IDC_EDIT_FAREWELL_FILE, m_csFarewellFile);
    DDX_Text(pDX, IDC_EDIT_CALLED_VOICE_PROMPT_NAME, m_csCalledVoicePromptName);
}
...
void CDlgAlarmOnekey::OnBnClickedBtnGetCallWaiting()
{
    ...
    m_iCalledWaitedTime = m_struCallWaitingCfg.wCalledWaitTime;
    UpdateData(FALSE);
}
...
void CDlgAlarmOnekey::OnBnClickedBtnSetCallWaiting()
{
    ...
    m_struCallWaitingCfg.wCalledWaitTime = (WORD)m_iCalledWaitedTime;
    NET_DVR_STD_CONFIG struStdConfig = { 0 };
...
void CDlgAlarmOnekey::OnBnClickedBtnGetVoicePromption()
{
    ...
    m_csWelcomeFile = m_struVoicePromptionCfg.byWelcomeFile;
    m_csFarewellFile = m_struVoicePromptionCfg.byFarewellFile;
    m_csCalledVoicePromptName = m_struVoicePromptionCfg.byCalledVoicePromptName;
    UpdateData(FALSE);
}
...
void CDlgAlarmOnekey::OnBnClickedBtnSetVoicePromption()
{
    ...
    memcpy(m_struVoicePromptionCfg.byWelcomeFile, (LPCSTR)m_csWelcomeFile, m_csWelcomeFile.GetAllocLength());
    memcpy(m_struVoicePromptionCfg.byFarewellFile, (LPCSTR)m_csFarewellFile, m_csFarewellFile.GetAllocLength());
    memcpy(m_struVoicePromptionCfg.byCalledVoicePromptName, (LPCSTR)m_csCalledVoicePromptName, m_csCalledVoicePromptName.GetAllocLength());
    NET_DVR_STD_CONFIG struStdConfig = { 0 };
