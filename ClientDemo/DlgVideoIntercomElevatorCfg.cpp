...
void CDlgVideoIntercomElevatorCfg::OnBtnGet() 
{
    ...
    if (m_struElevatorCfg.byElevatorControlType == 0xff)
    {
        m_cmbElevatorControlType.SetCurSel(m_comboInterfaceType.GetCount());
    }
    else
    {
...
void CDlgVideoIntercomElevatorCfg::OnBtnSet() 
{
    ...
    if (m_cmbElevatorControlType.GetCurSel() == m_cmbElevatorControlType.GetCount())
    {
        m_struElevatorCfg.byElevatorControlType = 0xff;
    }
    else
    {
