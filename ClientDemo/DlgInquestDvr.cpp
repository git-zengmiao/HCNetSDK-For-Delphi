...
void CDlgInquestDvr::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Control(pDX, IDC_CMB_PROCESSING_MODE, m_cmbProcessingMode);
    DDX_Check(pDX, IDC_CHK_CD_PRINT_ENABLED, m_bCDPrintEnabled);
	//}}AFX_DATA_MAP
}
...
void CDlgInquestDvr::CheckInitPara() 
{
    ...
    m_cmbProcessingMode.SetCurSel(m_strSystemInfo.byCDProcessingMode);
...
void CDlgInquestDvr::OnButtonSetupSystem() 
{
    ...
    m_strSystemInfo.byCDProcessingMode = m_cmbProcessingMode.GetCurSel();
...
void CDlgInquestDvr::OnButtonInquestRoomSysOk() 
{
    ...
    m_strSystemInfo.struInquestRoomInfo[iRoomIndex].byCDPrintEnabled = m_bCDPrintEnabled;
}
...
void CDlgInquestDvr::OnSelchangeComboInquestRoomSys() 
{
    ...
    m_bCDPrintEnabled = m_strSystemInfo.struInquestRoomInfo[iRoomIndex].byCDPrintEnabled;
	UpdateData(FALSE);
}
