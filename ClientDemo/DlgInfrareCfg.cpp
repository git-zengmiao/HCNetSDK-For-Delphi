...
void CDlgInfrareCfg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_EDIT15, m_dwRelativeFocusPos);
}
...
void CDlgInfrareCfg::OnBtnFocusmodeSet() 
{
    ...
    struFocusModeCfg.dwRelativeFocusPos = m_dwRelativeFocusPos;
...
void CDlgInfrareCfg::OnBtnFocusmodeGet() 
{
    ...
    m_dwRelativeFocusPos = struFocusModeCfg.dwRelativeFocusPos;
	UpdateData(FALSE);
}
