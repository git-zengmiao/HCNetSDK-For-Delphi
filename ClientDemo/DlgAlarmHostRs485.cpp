...
void CDlgAlarmHostRs485::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Control(pDX, IDC_COMBO_STAIRS_OUTPUT_TYPE, m_comboStairsOutputType);
}
...
void CDlgAlarmHostRs485::InitStairsOutputType()
{
    CString tmp;
    char szLan[128] = { 0 };
    m_comboStairsOutputType.ResetContent();

    g_StringLanType(szLan, "无效", "Invalid");
    m_comboStairsOutputType.AddString(szLan);
    m_comboStairsOutputType.SetItemData(0, 0);

    g_StringLanType(szLan, "输出楼层号", "Output FloorNo");
    m_comboStairsOutputType.AddString(szLan);
    m_comboStairsOutputType.SetItemData(1, 1);

    g_StringLanType(szLan, "输出卡号", "Output CardNo");
    m_comboStairsOutputType.AddString(szLan);
    m_comboStairsOutputType.SetItemData(2, 2);
}
...
void CDlgAlarmHostRs485::GetRs485CfgFromWnd(NET_DVR_ALARM_RS485CFG &struRs485Cfg)
{
    ...
    struRs485Cfg.byStairsOutputDataType = m_comboStairsOutputType.GetCurSel();
...
void CDlgAlarmHostRs485::SetRs485CfgToWnd(NET_DVR_ALARM_RS485CFG &struRs485Cfg)
{
    ...
    m_comboStairsOutputType.SetCurSel(struRs485Cfg.byStairsOutputDataType);
