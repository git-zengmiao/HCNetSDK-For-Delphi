...
protected:
	...
	afx_msg void OnBtnBlockallowlistUpload();
	afx_msg void OnBtnBlockallowlistDownload();
	afx_msg void OnBtnBlockallowlistDownloadStop();
	afx_msg void OnBtnBlockallowlistUploadStop();
	afx_msg void OnBtnBlockallowlistBrowse();
...
public:
    ...
    BOOL m_bPicRecognition;
    BOOL m_bEnableParkingDetect;
    int m_iParkingDuration;
    int m_iParkingAlarmIntervalTime;
};
