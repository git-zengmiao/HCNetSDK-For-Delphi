...
void CDlgDetectorRegister::AddInfoToDlg()
{
    ...
    {
        g_StringLanType(sTemp, "紧急按钮", "Panic Button");
        m_listData.SetItemText(m_iRowCount, 2, sTemp);
    }
    else if (m_struInfo.wDetectorType == 1)
    {
        g_StringLanType(sTemp, "门磁", "Magnetic Contact");
        m_listData.SetItemText(m_iRowCount, 2, sTemp);
    }
    ...
    {
        g_StringLanType(sTemp, "双鉴探测器", "Dual Technology PIR detector");
        m_listData.SetItemText(m_iRowCount, 2, sTemp);
    }
    ...
    {
        g_StringLanType(sTemp, "水浸探测器", "water detector");
        m_listData.SetItemText(m_iRowCount, 2, sTemp);
    }
    ...
    {
        g_StringLanType(sTemp, "其它探测器", "Other Detector");
        m_listData.SetItemText(m_iRowCount, 2, sTemp);
    }
    //UpdateData(FALSE);
}
