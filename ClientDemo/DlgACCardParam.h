...
#ifdef DEMO_LAN_CN
static char *pCardType[] = { "未知卡", "普通卡", "特殊群体卡", "禁止名单卡", "巡更卡", "胁迫卡", "超级卡", "来宾卡", "解除卡", "员工卡", "应急卡", "应急管理卡", "ESD全检卡", "ESD免检卡", "ESD足检卡", "ESD手检卡" };
#else
...
"ESDfullinspectioncard", "ESDinspectionexemptioncard", "ESDfootexemptioncard", "ESDhandexemptioncard"};
#endif
enum AddModeEum{
    SINGEL_ADD = 0,
    BATCH_ADD
