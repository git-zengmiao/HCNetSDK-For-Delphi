...
public:
    ...
    CComboBox m_CombScreenCheckType;
	long m_lHandle;
	long m_lUserID;
	long m_iDeviceIndex;
	long m_lRgbPermil;
    ...
    BOOL m_bDelFullScreenGamut;
    BOOL m_bDelLightPanelGamut;
    BOOL m_bDelLightPanelWhiteBalance;
    afx_msg void OnBnClickedCheckDelFullScreenGamut();
    afx_msg void OnBnClickedCheckDelLightPanelGamut();
    afx_msg void OnBnClickedCheckDelLightPanelWhiteBalance();
};
