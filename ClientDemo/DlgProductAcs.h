...
public:
    ...
    afx_msg void OnBnClickedBtnUploadCertificateBlockList();
    ...
    afx_msg void OnBnClickedBtnUploadBlockListPicture();
    afx_msg void OnBnClickedBtnUploadBlockList();
    afx_msg void OnBnClickedBtnCheckFacePicture();
    afx_msg void OnBnClickedBtnFaceTemplate();
    afx_msg void OnBnClickedBtnWorkMode();
    afx_msg void OnBnClickedBtnFaceConsume();
};
