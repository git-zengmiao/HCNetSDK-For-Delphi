...
void CDlgUploadLogo::DoDataExchange(CDataExchange* pDX)
{
    ...
    //}}AFX_DATA_MAP
    DDX_Text(pDX, IDC_EDIT_LOGO_NAME, m_strLogoName);
}
...
void CDlgUploadLogo::OnBtnGetLogoOverlaycfg() 
{
    ...
    m_strLogoName = m_struLogoOverlay.byLogoName;
	UpdateData(FALSE);
}
...
void CDlgUploadLogo::OnBtnSetLogoOverlaycfg() 
{
    ...
    strncpy((char *)m_struLogoOverlay.byLogoName, m_strLogoName.GetBuffer(), sizeof(m_struLogoOverlay.byLogoName));
