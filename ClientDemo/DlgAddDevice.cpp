...
void CDlgAddDevice::OnBnClickedAddDeviceOk()
{
	...
	if (strncmp(m_csNodeName.GetBuffer(0), "All", 3)==0)//Use "All.X" X means the device number，From 192.168.1.Y To 192.168.1.X+Y
	{
		...
		for (int i = 0; i<nErr; i++)
		{
			...
			sprintf(g_struDeviceInfo[iDeviceIndex].chLoginPwd, "abcd_");
    ...
    /*
    10.7.35.88 _45 //http->https重定向 (ISAPI 自适应)
    10.66.109.3_45 //
    10.7.35.14 _45
    10.7.34.163_45
    ...
    */
	...
	{		
		...
		sprintf(g_struDeviceInfo[m_iDeviceIndex].chDeviceMultiIP, "ff02::_");
#endif		
	}
    //2011-12-29
