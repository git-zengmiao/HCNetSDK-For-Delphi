...
BEGIN_MESSAGE_MAP(CDlgProductAcs, CDialog)
    ...
    ON_BN_CLICKED(IDC_BTN_UPLOAD_CERTIFICATE_BLOCKLIST, &CDlgProductAcs::OnBnClickedBtnUploadCertificateBlockList)
    ...
    ON_BN_CLICKED(IDC_BTN_UPLOAD_BLOCKLIST_PICTURE, &CDlgProductAcs::OnBnClickedBtnUploadBlockListPicture)
    ON_BN_CLICKED(IDC_BTN_UPLOAD_BLOCKLIST, &CDlgProductAcs::OnBnClickedBtnUploadBlockList)
    ...
    ON_BN_CLICKED(IDC_BTN_FACE_CONSUME, &CDlgProductAcs::OnBnClickedBtnFaceConsume)
END_MESSAGE_MAP()
...
void CDlgProductAcs::OnBnClickedBtnUploadCertificateBlockList()
{
    // TODO:  在此添加控件通知处理程序代码
    CDlgUploadBlockList dlg;
...
void CDlgProductAcs::OnBnClickedBtnUploadBlockListPicture()
{
    // TODO:  在此添加控件通知处理程序代码
    CDlgUploadBlockListPicture dlg;
    dlg.m_lServerID = m_lUserID;
    dlg.m_iDeviceIndex = m_iDeviceIndex;
    dlg.DoModal();
}
...
void CDlgProductAcs::OnBnClickedBtnUploadBlockList()
{
    // TODO:  在此添加控件通知处理程序代码
    CDlgBatchUploadBlockList dlg;
    dlg.m_lServerID = m_lUserID;
    dlg.m_iDeviceIndex = m_iDeviceIndex;
    dlg.DoModal();
}
...
void CDlgProductAcs::OnBnClickedBtnFaceConsume()
{
    // TODO:  在此添加控件通知处理程序代码
    CDlgFaceConsume dlg;
    dlg.m_lUserID = m_lUserID;
