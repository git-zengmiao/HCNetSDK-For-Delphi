...
void CDlgAlarmHostZoneCfg::IninAlarmInFangquTypeCombo()
{
    char szLan[128] = { 0 };
...
void CDlgAlarmHostZoneCfg::GetAlarmInParamFromWnd(NET_DVR_ALARMIN_PARAM_V50& struAlarmInParam)
{
    ...
    struAlarmInParam.byType = (m_comboFangquType.GetCurSel()>14) ? 0xff : m_comboFangquType.GetCurSel();
...
void CDlgAlarmHostZoneCfg::OnSelchangeComboFangquType()
{
