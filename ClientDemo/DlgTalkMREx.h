...
#define PCM_AUDENCSIZE      1920

#define MP2L2_AUDENCSIZE    576
#define MP2L2_AUDDECSIZE    576
...
public:
	...
	int m_iDeviceIndex;
    static DWORD WINAPI PlayAudioThread(LPVOID pParam);
	BOOL m_bWaveDeal;
    ...
    void SetWaveFormat(NET_DVR_COMPRESSION_AUDIO &struCodeType);
// Dialog Data
	//{{AFX_DATA(CDlgTalkMR)
...
protected:
    ...
    BYTE m_byAudioTemp[AUDENCSIZE];
    BYTE m_byAudioEncType;
	...
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
    void AudioBufDownScale(char const*in, char* out, int inbufLen) const;
    void StopSoundInAndSoundOut();
};
