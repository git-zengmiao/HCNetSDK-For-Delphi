...
void CDlgInfoDiffusionXmlUpdownload::DoDataExchange(CDataExchange* pDX)
{
    ...
    //}}AFX_DATA_MAP
    DDX_Control(pDX, IDC_COMBO_MaterialType, m_cmMaterialType);
}
...
void CDlgInfoDiffusionXmlUpdownload::OnBtnUpload() 
{
    ...
    switch (m_cmMaterialType.GetCurSel())
    {
    case 0:
        ...
        break;
    case 1:
        m_lUpdownloadHandle = NET_DVR_UploadFile_V40(m_lUserID, UPLOAD_CUSTOMAUDIO_FILE, m_szInputParam.GetBuffer(0), m_szInputParam.GetLength(), m_szFilePath.GetBuffer(0), szOutputBuff, sizeof(szOutputBuff));
        break;
    default:
        break;
    }
