...
BOOL CDlgDeviceAudioTalkCode::OnInitDialog()
{
    ...
    else if (m_struCodeType.byAudioEncType == 15)
    {
        iAudioEncType = 13;
    }
    else if (m_struCodeType.byAudioEncType == 16)
    {
        iAudioEncType = 14;
    }
...
void CDlgDeviceAudioTalkCode::OnBtnSave() 
{
    ...
    else if (iAudioEncType == 13)
    {
        m_struCodeType.byAudioEncType = 15;
    }
    else if (iAudioEncType == 14)
    {
        m_struCodeType.byAudioEncType = 16;
    }
    else
    {
        return;
