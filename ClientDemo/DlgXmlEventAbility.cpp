// DlgXmlEventAbility.cpp : implementation file
//
...
CDlgXmlEventAbility::CDlgXmlEventAbility(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgXmlEventAbility::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgXmlEventAbility)
...
void CDlgXmlEventAbility::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgXmlEventAbility)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlgXmlEventAbility, CDialog)
	//{{AFX_MSG_MAP(CDlgXmlEventAbility)
	ON_WM_DESTROY()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgXmlEventAbility message handlers
BOOL CDlgXmlEventAbility::OnInitDialog() 
{
...
BOOL CDlgXmlEventAbility::GetITCAbility()
{
    memset(m_pRecvBuf, 0, XML_BUF);
	//	strcpy(m_pSendBuf,"<AudioVideoCompressInfo><ChannelNumber>17</ChannelNumber></AudioVideoCompressInfo>");
    strcpy(m_pSendBuf,"<EventAbility  version=\"2.0\"><channelNO>1</channelNO></EventAbility >");
...
BOOL CDlgXmlEventAbility::WirteBufToFile(char *pBuf, DWORD dwBufSize)
{
    SYSTEMTIME t;
    GetLocalTime(&t);
    char chTime[128];
...
void CDlgXmlEventAbility::OnDestroy() 
{
	CDialog::OnDestroy();
