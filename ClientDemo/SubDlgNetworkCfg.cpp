...
BEGIN_MESSAGE_MAP(CSubDlgNetworkCfg, CDialog)
	...
	ON_BN_CLICKED(IDC_BTN_INTRANET_SEGMENT_CFG, OnBnClickedBtnIntranetSegmentCfg)
END_MESSAGE_MAP()
...
void CSubDlgNetworkCfg::OnBnClickedBtnIntranetSegmentCfg()
{
	// TODO:  在此添加控件通知处理程序代码
	CDlgIntranetSegmentCfg dlg;
	dlg.m_lUserID = m_lLoginID;
	dlg.m_iDevIndex = g_pMainDlg->GetCurDeviceIndex();
	dlg.DoModal();
}
